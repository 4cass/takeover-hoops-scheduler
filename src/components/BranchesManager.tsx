...
export function BranchesManager() {
  ...
  return (
    <div className="min-h-screen bg-white pt-4 p-2 sm:p-3 md:p-6">
              ...
              <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                ...
                <DialogContent className="w-[95vw] max-w-[95vw] sm:max-w-md bg-white border-2 border-[#181A18] p-2 sm:p-3 md:p-4">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="flex flex-col sm:flex-row justify-end space-y-2 sm:space-y-0 sm:space-x-3 gap-2">
                      <Button
                        type="button"
                        variant="outline"
                        onClick={resetForm}
